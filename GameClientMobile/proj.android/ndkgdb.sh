APPNAME="game"
APP_ANDROID_NAME="com.roughhands.game"
...
# ... use paths relative to current directory
    COCOS2DX_ROOT="$DIR/../GameClientMobile/libs"
    APP_ROOT="$DIR/../GameClientMobile"
    APP_ANDROID_ROOT="$DIR"
else
    APP_ROOT="$COCOS2DX_ROOT/../"
    APP_ANDROID_ROOT="$COCOS2DX_ROOT/../../proj.android"
fi
